...
export const persistedGameSchema = z.object({
  ...
  settings: z.object({ music: z.boolean(), sound: z.boolean(), haptics: z.boolean(), reducedMotion: z.boolean(), battleSpeed: z.union([z.literal(1), z.literal(1.5), z.literal(2)]).default(1) }),
